...
init-y :=
core-y := platform/ services/multimedia/ utils/ platform/main/ platform/hal/ utils/intersyshci/ $(BLUETOOTH_BTH_DIR_PATH)/ utils/hsm/
...
AUDIO_BASS_ENHANCER ?= 1

OTA_BIN_COMPRESSED ?= 1
OTA_USE_DIFF ?= 1
